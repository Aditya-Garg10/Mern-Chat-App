...
const createToken = (email,UserId) =>{
    return jwt.sign({email,UserId}, process.env.JWT_KEY, {expiresIn: expire})
};
...
export const addProfileImage = async(req,res) =>{
    try {
        if(!req.file){
            ...
            const { UserId } = req.body
            const updatedUser = await User.findOneAndUpdate({_id: UserId},{image: fileName},{new:true, runValidators: true})
