          ...
          <div className='flex flex-col gap-10 items-center justify-center '>
            <div className='flex  items-center justify-center flex-col'>
              <div className='flex items-center justify-center '>
                <h1 className='text-6xl  font-bold md:text-4xl sm:text-2xs'>Welcome</h1>
            ...
            <Tabs className='w-3/4'>
              ...
              <TabsContent value='login' className='flex flex-col gap-5 mt-10'>
                ...
                <Input placeholder="Password" type="password" className="rounded-full p-6" value={email} onChange={(e)=> setpassword(e.target.value)}></Input>                
                <Button className="rounded-full p-6" onClick={handleLogin}>Login</Button>
              </TabsContent>
              <TabsContent value='signup' className='flex flex-col gap-5 '>
              <Input placeholder="Email" type="email" className="rounded-full  p-6" value={email} onChange={(e)=> setemail(e.target.value)}></Input>
                <Input placeholder="Password" type="password" className="rounded-full  p-6" value={email} onChange={(e)=> setpassword(e.target.value)}></Input>
              <Input placeholder="Confirm Password" type="password" className="rounded-full  p-6" value={email} onChange={(e)=> setconfirmpassword(e.target.value)}></Input>
